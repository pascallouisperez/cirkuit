...
public class SplashScreen extends Canvas {
	...
	public SplashScreen() {
		...
		image = getToolkit().getImage("./shared/image/splash.png");
	...
	public synchronized void paint(Graphics g)
	{
		...
		offscreenGfx.fillRect(1,image.getHeight(this) + 1, ((win.getWidth() - 2) * progress) / 6,PROGRESS_HEIGHT);

		offscreenGfx.setColor(Color.gray);

		String str = "Version "+CirKuit.VERSION;

		offscreenGfx.drawString(str, (getWidth() - fm.stringWidth(str)) / 2,	image.getHeight(this)+1 - fm.getDescent() - 10);
